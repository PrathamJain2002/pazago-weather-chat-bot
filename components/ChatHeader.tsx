...
export default function ChatHeader({ messageCount, onClearChat, hasMessages, threadName }: ChatHeaderProps) {
  return (
      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-sm text-blue-100">
            {threadName ? `${threadName} • Ask me anything about the weather` : 'Ask me anything about the weather'}
          </p>
        </div>
      </div>
